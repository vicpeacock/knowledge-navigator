...
# Copia la connection string URI e sostituisci [PASSWORD] con la password del database
# Formato: postgresql+asyncpg://postgres:[PASSWORD]@db.zdyuqekimdpsmnelzvri.supabase.co:5432/postgres
DATABASE_URL=postgresql+asyncpg://postgres:[PASSWORD]@db.zdyuqekimdpsmnelzvri.supabase.co:5432/postgres
...
echo "   3. Sostituisci [PASSWORD] in DATABASE_URL e POSTGRES_PASSWORD"
echo ""
